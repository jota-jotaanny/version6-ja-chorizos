export default function WebMaquetaChorizos() {
  // ✅ Versión 5 – más gráfica, logos correctos y CTA fuerte
  // IMPORTANTE: coloca estas imágenes en /public con EXACTOS nombres:
  //  /logo-oficial-ja.jpg            (renombra tu "LOGO OFICICAL J&A EN JPEG.jpeg")
  //  /logo-chorizos.png              (logo circular CHORIZOS)
  //  /logo-morcillas.png             (logo circular MORCILLAS)
  //  /chorizos_base.png              (bandeja chorizos)
  //  /chorizo-y-morcilla-773x458.jpeg (plato mixto)

  const waPhone = "573206574077"; // 57 + 3206574077
  console.assert(waPhone.startsWith("57") && waPhone.length === 12, "WhatsApp phone must include country code 57 and be 12 digits long");
  const waLink = "https://wa.me/" + waPhone;

  return (
    <div className="min-h-screen bg-white text-gray-900">
      {/* HERO con imagen de fondo (más vendedor) */}
      <section className="relative overflow-hidden text-white">
        ...
        {/* Logo oficial arriba a la derecha (pequeño) */}
      ...
      {/* COMBOS FAMILIARES – etiquetas que NO tapan la foto */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          ...
          <div className="rounded-2xl shadow-lg bg-white overflow-hidden">
            <div className="relative h-56 md:h-72 w-full">
              <img
                src="/chorizos_base.png"
                alt="Bandeja de chorizos artesanales J&A"
          ...
          <div className="rounded-2xl shadow-lg bg-white overflow-hidden">
            <div className="relative h-56 md:h-72 w-full">
              <img
                src="/chorizo-y-morcilla-773x458.jpeg"
                alt="Chorizo y morcilla artesanales J&A"
                className="w-full h-full object-cover"
                loading="lazy"
              />
      ...
      {/* FOOTER con logos de recordación */}
